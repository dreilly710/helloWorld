...
with app.app_context():
    ...
    users = [
        {'username': 'dreilly1', 'email': 'dreilly1@terpmail.umd.edu', 'first_name': 'Daniel', 'last_name': 'Reilly',
         'password': generate_password_hash('dreilly1', method='pbkdf2:sha256'), 'role': 'STUDENT'},
    ...
    students = [
        {'first_name': 'Daniel', 'last_name': 'Reilly', 'email': 'dreilly1@terpmail.umd.edu',
         'major_id': 3, 'birth_date': dt.strptime('2004-01-01', '%Y-%m-%d'), 'is_honors': 0}
    ]
